    ...
    items.push(
      <>
        <p>
          ...
          {commentInfo.movies[commentInfo.movie_ids[i]][0]}
        </p>
        <button onClick={() => DeleteComment(commentInfo.review_ids[i], i)}>Delete Comment</button>
        <br />
        <p>
          rating:
          {commentInfo.ratings[i]}
        </p>
        <p>
          review:
          {commentInfo.texts[i]}
